...
Security-focused Dockerfile linter with 46 built-in rules (SEC001-SEC046) covering CIS Docker Benchmark, container hardening standards, and security best practices.
...
The Dockerfile Security Lint MCP server provides AI-assisted linting directly in your editor. Requires PayPal VPN.
...
```json
{
  "mcpServers": {
    "image-security-lint": {
      "url": "https://aiplatform.dev51.cbf.dev.paypalinc.com/byoa/image-security--0243a/sse"
    }
  }
}
```
...
```toml
[mcp_servers.image-security-lint]
type = "sse"
url = "https://aiplatform.dev51.cbf.dev.paypalinc.com/byoa/image-security--0243a/sse"
```
...
# Write to file
image-security-lint --format json > results.json
